 ...
 */
//@1
@Service("HttpUtil_okex_quarter")
public class HttpUtil_okex_quarter extends BaseHttp {
	...
	public void getKLineData(Markethistory marketHistory,MarketHistoryMapper marketHistoryMapper,Long size,Long dbCurrentTime) {
		String url="https://www.okex.com/api/v1/future_kline.do?type=1min&contract_type=quarter&size="+size+"&symbol="+marketHistory.getMoneypair();
